                ...
                <div class="row py-2">
                  <div class="col">
                    <label class="inp" for="name">
                      <input type="text" class="form-control" name="name" id="name" value="{{ old('name', $component->name) }}">
                ...
                <div class="row py-2">
                  <div class="col">
                    <label class="inp" for="description">
                      <input class="form-control" name="description" id="description" type="text" value="{{ old('name', $component->description) }}">
                ...
                <div class="row py-2">
                  <div class="col">
                    <label class="inp" for="good_for">
                      <input type="text" class="form-control" name="good_for" id="good_for" value="{{ old('good_for', $component->good_for) }}">
