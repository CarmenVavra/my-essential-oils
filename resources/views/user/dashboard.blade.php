        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row py-4">
              ...
              <div class="col-md-4">
                <div class="card bg-card-incredients">
                  <div class="card-body">
                    <h5 class="card-title">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-box-arrow-in-down-right" viewBox="0 0 16 16">
