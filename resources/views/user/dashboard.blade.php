      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{ route('admin.essentialoils.index') }}" class="card-link btn btn-sm btn-primary">Enter</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
            ...
            <div class="row py-4">
              <div class="col-md-4">
                <div class="card bg-card-application">
                  <div class="card-body">
                    <h5 class="card-title">
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-chevron-bar-contract" viewBox="0 0 16 16">
              ...
              <div class="col-md-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="{{ route('admin.incredients.index') }}" class="card-link btn btn-sm btn-primary">Enter</a>
                  </div>
                </div>
              </div>
            </div>
